...
- `INKSTONE_COMMENTS_SYNC_SECS` (default: `432000`, comment sync interval)
...
- `INKSTONE_GITHUB_APP_INSTALLATION_ID` (GitHub App installation id)
- `INKSTONE_GITHUB_APP_PRIVATE_KEY` (GitHub App private key PEM)
- `INKSTONE_GITHUB_REPO_OWNER` (GitHub repo owner)
- `INKSTONE_GITHUB_REPO_NAME` (GitHub repo name)
- `INKSTONE_GITHUB_DISCUSSION_CATEGORY_ID` (GitHub discussion category id)
...
INKSTONE_COMMENTS_SYNC_SECS=432000 \
...
INKSTONE_GITHUB_APP_INSTALLATION_ID=12345678 \
INKSTONE_GITHUB_APP_PRIVATE_KEY="-----BEGIN PRIVATE KEY-----\n...\n-----END PRIVATE KEY-----" \
INKSTONE_GITHUB_REPO_OWNER=yourname \
